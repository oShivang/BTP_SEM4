...
def _beam_search(batch_of_prompts, config: Config, slm: LLM, prm: Scorer, llm: None) -> tuple:
...
def smart_beam_search_conf(examples, config: Config, slm: LLM, prm: Scorer, llm: None):
