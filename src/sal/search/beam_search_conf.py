...
def _beam_search(batch_of_prompts, config: Config, llm: LLM, prm: Scorer) -> tuple[list[Beam], int, list]:
...
def beam_search_conf(examples, config: Config, llm: LLM, prm: Scorer):
